    ...
    return (
        <div className="sticky top-0 h-screen w-14 lg:w-56 bg-black border-r border-gray-800 flex flex-col p-2">
            ...
            <div className="p-2 mb-2">
                <div
                    className="w-7 h-7 flex items-center justify-center cursor-pointer hover:bg-gray-900/50 rounded-full transition-colors duration-200">
                    <svg
            ...
            <div className="p-2 border-t border-gray-800">
                ...
                >
                    <Avatar className="w-10 h-10">
                        <div
                            className="w-full h-full bg-gray-700 text-white flex items-center justify-center"
                        />
                    </Avatar>
    ...
    return (
        <div className="sticky top-0 h-screen w-72 lg:w-80 bg-black p-3 hidden lg:block">
            ...
            <div className="rounded-xl p-2 mb-3 border border-gray-800 shadow-md">
                ...
                <Button
                    className="bg-blue-500 hover:bg-blue-600 text-white px-3 py-1 rounded-xl font-bold text-xs transition-colors duration-200">
                    Subscribe
                </Button>
            </div>
            ...
            <div className="rounded-xl p-2 mb-3 border border-gray-800 shadow-md">
                <div className="flex items-center justify-between mb-2">
                    ...
                    <X className={'text-gray-500 hover:text-gray-300 hover:cursor-pointer'}/>
                </div>
            ...
            <div className="rounded-xl p-2 mb-3 border border-gray-800 shadow-md">
                ...
                {whoToFollow.map((user, index) => (
                    ...
                    >
                        ...
                        <Button
                            className="bg-blue-500 hover:bg-blue-600 text-white px-2 py-1 rounded-xl text-xs transition-colors duration-200">
                            Follow
                        </Button>
                    </div>
                ))}
